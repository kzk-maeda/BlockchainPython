...
def create_transaction():
    ...
    response = requests.post(
        urllib.parse.urljoin(app.config['gateway'], 'transaction'),
    ...
    return jsonify({'message': 'faild', 'response': response}), 400
...
if __name__ == "__main__":
    ...
    parser.add_argument('-g', '--gateway', default='http://127.0.0.1:5000', type=str, help='Blockchain Gateway')
